...
**Onde salvar (escolher conforme contexto):**
- Análise relacionada a um cliente específico → `clientes/[nome-cliente]/relatorios/analise-[tema]-[data].md`
- Análise geral / pesquisa / estudo de mercado → `dados/analises/analise-[tema]-[data].md`
- Análise relacionada ao infoproduto → `infoproduto/pesquisa/analise-[tema]-[data].md`
